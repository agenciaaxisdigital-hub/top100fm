  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-[#0a1f44] text-white">
        <div className="pointer-events-none absolute -top-40 -right-32 h-[420px] w-[420px] rounded-full bg-[#ffc107]/20 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-12 md:py-20">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tight leading-[0.95]">
            Nossos{" "}
            <span className="bg-gradient-to-r from-[#ffc107] to-[#ffda6a] bg-clip-text text-transparent">
              Podcasts
            </span>
          </h1>
          ...
          <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-white/5 border border-white/10 px-3.5 py-1.5 text-xs">
            ...
            <span className="font-bold">{podcasts.length}</span>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {podcasts.map((p) => {
              ...
              return (
                <article
                  key={p.id}
                  className="group rounded-2xl border border-gray-200/80 bg-white overflow-hidden hover:border-[#0a1f44]/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
                >
                  {/* Thumbnail / Player */}
                      ...
                      <>
                        ...
                        <div className="absolute inset-0 bg-black/30 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="h-14 w-14 rounded-full bg-[#ffc107] text-[#0a1f44] flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
                        ...
                        <div className="absolute bottom-2 right-2">
                          <button
                            onClick={() => setPlaying(p.id)}
                            className="h-10 w-10 rounded-full bg-[#ffc107] text-[#0a1f44] flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
                            aria-label="Reproduzir"
                          >
                  ...
                  {/* Info */}
                  <div className="p-4">
                    <h3 className="font-bold text-[#0a1f44] text-sm md:text-base leading-tight line-clamp-2 mb-1">
                      {p.title}
                    </h3>
                    {p.description && (
