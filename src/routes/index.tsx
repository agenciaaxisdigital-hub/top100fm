              ...
              <div className="relative z-10 lg:col-span-6">
                ...
                {homeSocialLinks.length > 0 && (
                  <div className="mt-6 flex items-center gap-2.5 flex-wrap">
                    <span className="text-[10px] text-white/35 font-bold uppercase tracking-[0.25em] shrink-0">
                      Siga-nos
                    </span>
                      ...
                      {homeSocialLinks.map((link, i) => {
                        ...
                        return (
                          <a
                            ...
                            rel="noopener noreferrer"
                            title={name}
                            className={`inline-flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-[11px] font-bold text-white transition-all duration-200 hover:scale-105 hover:shadow-lg ${
                              isInsta
                                ? "bg-gradient-to-r from-[#f09433] via-[#dc2743] to-[#bc1888] shadow-[0_4px_12px_-4px_rgba(220,39,67,0.5)]"
                                : isWhatsApp
                                ? "bg-[#25D366] shadow-[0_4px_12px_-4px_rgba(37,211,102,0.5)]"
                                : isYoutube
                                ? "bg-[#FF0000] shadow-[0_4px_12px_-4px_rgba(255,0,0,0.45)]"
