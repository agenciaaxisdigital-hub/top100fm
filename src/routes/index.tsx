            ...
            <div className="grid items-start gap-6 lg:grid-cols-12">
              <div className="relative z-10 lg:col-span-6">
                ...
                <div className="mt-5 flex items-center gap-3">
                  ...
                  <a href="https://wa.me/5562981880895?text=Ol%C3%A1%2C%20TOP100%20FM!" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" title="WhatsApp"
          ...
          <section className="bg-white py-14 border-b border-gray-100">
            <div className="mx-auto max-w-7xl px-4">
              ...
              <div className="mt-8 text-center">
                <a
                  href="https://wa.me/5562981880895?text=Quero%20ser%20patrocinador%20da%20TOP100%20FM"
                  target="_blank"
                  rel="noopener"
