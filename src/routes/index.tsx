          ...
          <div className="relative mx-auto max-w-7xl px-3 sm:px-4 pt-6 pb-8 lg:pt-16 lg:pb-20">
            ...
            <div className="grid items-start gap-6 lg:grid-cols-12">
              <div className="relative z-10 lg:col-span-6">
                ...
                {/* Redes sociais no hero — só ícones */}
                    ...
                    {homeSocialLinks.map((link, i) => {
                      ...
                      return (
                        <a
                          ...
                          title={name}
                          aria-label={name}
                          className={`flex h-10 w-10 items-center justify-center rounded-full text-white shadow-lg transition-all duration-200 hover:scale-110 hover:shadow-xl ${
                            isInsta
