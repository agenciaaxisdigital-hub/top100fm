          ...
          {socialLinks.length > 0 && (
            <div className="flex gap-3">
              {socialLinks.map((link: any, i: number) => {
                ...
                const isFacebook = url.includes("facebook") || url.includes("fb.com");
                ...
                return (
                  <a
                    ...
                    title={name}
                    aria-label={name}
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/70 transition-all hover:scale-110 hover:bg-white/20 hover:text-white"
                  >
                    {isInsta && (
                    ...
                    {!isInsta && !isWhatsApp && !isYoutube && !isTiktok && !isFacebook && !isTwitter && (
